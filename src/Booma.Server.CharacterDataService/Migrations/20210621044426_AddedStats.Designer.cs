...
namespace Booma.Server.CharacterDataService.Migrations
{
    ...
    [Migration("20210621044426_AddedStats")]
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacterStatDefault<Booma.CharacterStatType, Booma.CharacterRace, Booma.CharacterClass>", b =>
                {
                    ...
                    b.OwnsMany("Glader.ASP.RPG.RPGStatDefinition<Booma.CharacterStatType>", "Stats", b1 =>
                        {
                            b1.Property<int>("Key")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");

                            b1.Property<byte>("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>ClassId")
                                .HasColumnType("tinyint unsigned");

                            b1.Property<int>("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>Level")
                                .HasColumnName("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, Ch~1")
                                .HasColumnType("int");

                            b1.Property<int>("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>RaceId")
                                .HasColumnName("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, Ch~2")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>Level", "DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>RaceId", "DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>ClassId");

                            b1.ToTable("RPGStatDefinition<CharacterStatType>");

                            b1.WithOwner()
                                .HasForeignKey("DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>Level", "DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>RaceId", "DBRPGCharacterStatDefault<CharacterStatType, CharacterRace, CharacterClass>ClassId");
                        });
                });
