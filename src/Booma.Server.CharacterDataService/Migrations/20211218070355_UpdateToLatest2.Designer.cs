...
namespace Booma.Server.CharacterDataService.Migrations
{
    ...
    [Migration("20211218070355_UpdateToLatest2")]
    partial class UpdateToLatest2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacterItemDefault<Booma.CharacterRace, Booma.CharacterClass, Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacterItemInventory<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGItemInstance<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGItemInstanceOwnership<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGMap", b =>
                {
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacterItemDefault<Booma.CharacterRace, Booma.CharacterClass, Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    ...
                    b.HasOne("Glader.ASP.RPG.DBRPGItemTemplate<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", "ItemTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacterItemInventory<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    ...
                    b.HasOne("Glader.ASP.RPG.DBRPGItemInstanceOwnership<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", "ItemOwnership")
                        .WithMany()
                    ...
                    b.OwnsMany("Glader.ASP.RPG.RPGStatValue<Booma.CharacterStatType>", "Stats", b1 =>
                        {
                            ...
                            b1.ToTable("character_stat_default_rpgstats");
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGItemInstance<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.HasOne("Glader.ASP.RPG.DBRPGItemTemplate<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGItemInstanceOwnership<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", b =>
                {
                    b.HasOne("Glader.ASP.RPG.DBRPGItemInstance<Booma.ItemClassType, Booma.PsobbQuality, Booma.Vector3<byte>>", "Instance")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGMap", b =>
                {
                    b.OwnsOne("Glader.Essentials.Vector3<float>", "EntryPoint", b1 =>
                        {
                            b1.Property<int>("DBRPGMapMapId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("DBRPGMapMapId");

                            b1.ToTable("map");

                            b1.WithOwner()
                                .HasForeignKey("DBRPGMapMapId");
                        });
                });
